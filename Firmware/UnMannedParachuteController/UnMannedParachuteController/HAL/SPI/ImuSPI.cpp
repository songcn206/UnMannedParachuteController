...
struct ImuSpi :: ImuSettings s6 = {.addr = 127, .value = 0};		// REG_BANK_SEL: Change to 0


struct ImuSpi :: ImuSettings s7 = {.addr = 3, .value = 0b00110000}; // USER_CTRL: Enable I2C master
	
struct ImuSpi :: ImuSettings s8 = {.addr = 127, .value = 0b00110000}; // REG_BANK_SEL: Change to 3
...
struct ImuSpi :: ImuSettings s15 = {.addr = 3, .value = 0b00001100}; // I2C_SLV0_ADDR: physical address (0x0c) and write
struct ImuSpi :: ImuSettings s16= {.addr = 4, .value = 0x31};		// I2C_SLV0_REG: slave control register
struct ImuSpi :: ImuSettings s17 = {.addr = 6, .value = 0b00000010}; // I2C_SLV0_DO: continuous mode 2
	
struct ImuSpi :: ImuSettings s18 = {.addr = 3, .value = 0b10001100}; // I2C_SLV0_ADDR: physical address (0x0c) and read
struct ImuSpi :: ImuSettings s19 = {.addr = 4, .value = 0x11};		// I2C_SLV0_REG: slave data register	
struct ImuSpi :: ImuSettings s20 = {.addr = 6, .value = 0b11111111}; // I2C_SLV0_DO: dummy
